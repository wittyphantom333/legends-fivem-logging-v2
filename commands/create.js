module.exports = {
	...
	async execute(message) {
		...
		if(content.toLowerCase().startsWith(`${client[1].config.prefix}legendsDiscordLogs create`)){
...
\`\`\`\n*More info about using the export can be found here: <https://docs.legendsSystems.com/legendsDiscordLogs/export>*`)
